...
{
    // TODO: Replace the placeholder with the product of panelCount and
    // kilogramsPerPanel, then return that calculated material load.
    return 0;
}

int addToolLoad(int materialLoad, int toolLoad)
{
    // TODO: Replace the placeholder with the sum of materialLoad and toolLoad,
    // then return that calculated system load.
    return 0;
}
