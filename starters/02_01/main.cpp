...
void checkFlashing()
{
    // TODO: Use std::cout to write exactly "Flashing secure" and a newline.
}

void checkVent()
{
    // TODO: Use std::cout to write exactly "Vent clear" and a newline.
}

void inspectRoof()
{
    // TODO: Write the exact start line, call checkFlashing(), then
    // checkVent(), and finally write the exact completion line.
}
